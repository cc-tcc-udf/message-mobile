...
class MensagensFavoritasPage extends StatefulWidget {
  const MensagensFavoritasPage({super.key});

  @override
  State<MensagensFavoritasPage> createState() => _MensagensFavoritasPageState();
}

class _MensagensFavoritasPageState extends State<MensagensFavoritasPage> {
